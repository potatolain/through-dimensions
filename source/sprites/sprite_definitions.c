...
const unsigned char spriteDefinitions[] = {
    ...
    // FIXME: Color swap shouldn't be
    SPRITE_TYPE_TRANSITION, 0x48, SPRITE_SIZE_16PX_16PX | SPRITE_PALETTE_0, SPRITE_ANIMATION_SWAP, SPRITE_MOVEMENT_NONE, 0x01, 0x02, 0x00
};